...
-- Drop in dependency order (fact first), then recreate
...
LEFT JOIN silver.erp_cust_az12 AS ca ON ci.cst_id = ca.cid
LEFT JOIN silver.erp_loc_a101   AS la ON ci.cst_id = la.cid;
